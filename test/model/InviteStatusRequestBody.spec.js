...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiIdaasSdkJavascript.InviteStatusRequestBody();
  });
  ...
  describe('InviteStatusRequestBody', function() {
    it('should create an instance of InviteStatusRequestBody', function() {
      // uncomment below and update the code to test InviteStatusRequestBody
      //var instance = new ApiIdaasSdkJavascript.InviteStatusRequestBody();
      //expect(instance).to.be.a(ApiIdaasSdkJavascript.InviteStatusRequestBody);
    });
